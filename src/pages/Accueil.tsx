...
const Accueil: React.FC = () => {
  return (
    <div className="min-h-screen bg-cover bg-center bg-no-repeat flex justify-center items-start pt-20 px-6 relative">
      <div className="max-w-3xl w-full flex flex-col items-center text-center bg-white/10 backdrop-blur-lg border border-white/20 p-8 rounded-3xl shadow-2xl relative z-10">
        ...
        <Link
          to="/analyse"
          className="inline-block mt-6 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-xl shadow-lg transition duration-300 hover:scale-105"
        >
